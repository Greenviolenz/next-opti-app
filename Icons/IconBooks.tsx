...
const IconBooks = ({ height, width, className = 'fill-black' }: SvgProps) => (
  <svg
    height={height}
    width={width}
    className={className}
  ...
  >
    <g>
      <g>
        <g>
          <path
            d="M434.269,403.635c0.083-0.083,0.158-0.173,0.24-0.257c0.373-0.384,0.73-0.774,1.065-1.172
          ...
          />
          <path
            d="M194.539,245.76h81.92c11.311,0,20.48-9.169,20.48-20.48s-9.169-20.48-20.48-20.48h-81.92
				c-11.311,0-20.48,9.169-20.48,20.48S183.229,245.76,194.539,245.76z"
          />
          <path
            d="M153.579,327.68h122.88c11.311,0,20.48-9.169,20.48-20.48s-9.169-20.48-20.48-20.48h-122.88
